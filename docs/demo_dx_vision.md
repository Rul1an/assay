# Vision: Verdict DX 2025 (State of the Art)

**Goal**: Transform Verdict from a "CI Tool" into an "Interactive Governance Platform".
...
Static text logs are dead. Verdict's new demos should feel like a *Combat Initializer*:
...
*   **Right Panel**: Verdict Watchtower (Real-time policy evaluation).
...
3.  **Long Term**: Build a `verdict tui` subcommand in Rust (`ratatui`) for the core binary.
