...
- [ ] **`P2c` — A2A discovery/card follow-up pack** — [PLAN-P2c](architecture/PLAN-P2c-A2A-DISCOVERY-CARD-FOLLOWUP-PACK.md): productization **after** G4-A Phase 1 evidence; pack YAML/rules **not** frozen until Phase 1 of that plan
