...
> **Sequence:** `T1a → T1b → G3 → P2a → H1 → P2b` shipped on `main` (**`a2a-signal-followup`** in **v3.3.0**). **`G4-A` Phase 1** (A2A `payload.discovery` evidence seam) is **shipped on `main`** — [G4-A freeze](architecture/G4-A-PHASE1-FREEZE.md), [PLAN-G4](architecture/PLAN-G4-A2A-DISCOVERY-CARD-EVIDENCE-2026q2.md). **Immediate follow-up:** post-merge verification / release-truth hygiene only (no new G4 semantics). **Next capability wave:** **`P2c`** — A2A discovery/card follow-up pack — [PLAN-P2c](architecture/PLAN-P2c-A2A-DISCOVERY-CARD-FOLLOWUP-CLAIM-PACK.md), [RFC-005](architecture/RFC-005-trust-compiler-mvp-2026q2.md) §6, [PLAN-G4 §P2c](architecture/PLAN-G4-A2A-DISCOVERY-CARD-EVIDENCE-2026q2.md#p2c--follow-on-not-g4). References: [PLAN-T1b](architecture/PLAN-T1b-TRUST-CARD-2026q2.md), [PLAN-G3](architecture/PLAN-G3-AUTHORIZATION-CONTEXT-EVIDENCE-2026q2.md), [PLAN-H1](architecture/PLAN-H1-TRUST-KERNEL-ALIGNMENT-RELEASE-HARDENING.md), [MIGRATION-TRUST-COMPILER-3.2.md](architecture/MIGRATION-TRUST-COMPILER-3.2.md).
...
March 2026 evidence and signal waves change the ordering inside Q3. `T1a`, `T1b`, `G3`, **`P2a`**, **`H1`**, and **`P2b`** (`a2a-signal-followup`) are shipped on `main`; **`G4-A` Phase 1** (A2A `payload.discovery`) is **shipped on `main`**. **Immediate follow-up:** post-merge verification / release-truth hygiene only. **Next capability wave:** **`P2c`** (A2A discovery/card follow-up pack — [PLAN-P2c](architecture/PLAN-P2c-A2A-DISCOVERY-CARD-FOLLOWUP-CLAIM-PACK.md)), not more observability UI or unconstrained pack expansion.
...
| **P1** | `P2` Protocol Claim Packs (further slices) | ✅ **`P2b`** `a2a-signal-followup` (A2A-001..003) on **`v3.3.0`**. ✅ **`G4-A` Phase 1** on `main` (`payload.discovery`). **Next:** **`P2c`** (and further slices as needed). | [PLAN-P2b](architecture/PLAN-P2b-A2A-SIGNAL-FOLLOWUP-CLAIM-PACK.md); [PLAN-P2c](architecture/PLAN-P2c-A2A-DISCOVERY-CARD-FOLLOWUP-CLAIM-PACK.md); [PLAN-G4](architecture/PLAN-G4-A2A-DISCOVERY-CARD-EVIDENCE-2026q2.md); [G4-A freeze](architecture/G4-A-PHASE1-FREEZE.md). |
...
- [ ] **`P2c` — A2A discovery/card follow-up pack** — [PLAN-P2c](architecture/PLAN-P2c-A2A-DISCOVERY-CARD-FOLLOWUP-CLAIM-PACK.md): productization **after** G4-A Phase 1 evidence; pack YAML/rules **not** frozen until Phase 1 of that plan
