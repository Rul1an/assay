...
| **P1** | `P2` Protocol Claim Packs (further slices) | ✅ **`P2b`** `a2a-signal-followup` (A2A-001..003) on **`v3.3.0`**. ✅ **`G4-A` Phase 1** on `main` (`payload.discovery`). **Next:** **`P2c`** (and further slices as needed). | [PLAN-P2b](architecture/PLAN-P2b-A2A-SIGNAL-FOLLOWUP-CLAIM-PACK.md); [PLAN-G4](architecture/PLAN-G4-A2A-DISCOVERY-CARD-EVIDENCE-2026q2.md); [G4-A freeze](architecture/G4-A-PHASE1-FREEZE.md). |
...
- [ ] **`P2c` — A2A discovery/card follow-up pack** (sequencing label; detailed scope in a follow-on plan): productization **after** G4-A Phase 1 evidence — pack rules **not** frozen here
