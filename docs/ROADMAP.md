...
> **Status sync (2026-03-27):** Q1 DX/refactor convergence is closed on `main` (RFC-001/002/003/004).
...
> **Sequence:** `T1a → T1b → G3 → P2a → H1 → P2b` shipped on `main` (**`a2a-signal-followup`** in **v3.3.0**). **`G4-A` Phase 1** (A2A `payload.discovery` evidence seam) is **shipped on `main`** — [G4-A freeze](architecture/G4-A-PHASE1-FREEZE.md), [PLAN-G4](architecture/PLAN-G4-A2A-DISCOVERY-CARD-EVIDENCE-2026q2.md). **`P2c`** — built-in **`a2a-discovery-card-followup`** (A2A-DC-001 / A2A-DC-002) — is **shipped on `main`** — [PLAN-P2c](architecture/PLAN-P2c-A2A-DISCOVERY-CARD-FOLLOWUP-PACK.md), [RFC-005](architecture/RFC-005-trust-compiler-mvp-2026q2.md) §6, [PLAN-G4 §P2c](architecture/PLAN-G4-A2A-DISCOVERY-CARD-EVIDENCE-2026q2.md#p2c--follow-on-not-g4). **G4-A** follow-up remains post-merge verification / release-truth hygiene only (no new G4 semantics). **Next decision point:** not automatically another pack; the current best candidate is a bounded **A2A handoff / delegation-route visibility evidence wave**, with **MCP authorization-discovery** as the second candidate — see [DISCOVERY-NEXT-EVIDENCE-WAVE-2026Q2.md](architecture/DISCOVERY-NEXT-EVIDENCE-WAVE-2026Q2.md). References: [PLAN-T1b](architecture/PLAN-T1b-TRUST-CARD-2026q2.md), [PLAN-G3](architecture/PLAN-G3-AUTHORIZATION-CONTEXT-EVIDENCE-2026q2.md), [PLAN-H1](architecture/PLAN-H1-TRUST-KERNEL-ALIGNMENT-RELEASE-HARDENING.md), [MIGRATION-TRUST-COMPILER-3.2.md](architecture/MIGRATION-TRUST-COMPILER-3.2.md).
...
March 2026 evidence and signal waves change the ordering inside Q3. `T1a`, `T1b`, `G3`, **`P2a`**, **`H1`**, **`P2b`** (`a2a-signal-followup`), **`G4-A` Phase 1** (A2A `payload.discovery`), and **`P2c`** (`a2a-discovery-card-followup`) are shipped on `main`. **G4-A** track: post-merge verification / release-truth hygiene only. **Next decision point:** not automatically another pack; current discovery favors a bounded **A2A handoff / delegation-route visibility evidence wave** before any further P-slice is formalized — see [DISCOVERY-NEXT-EVIDENCE-WAVE-2026Q2.md](architecture/DISCOVERY-NEXT-EVIDENCE-WAVE-2026Q2.md).
