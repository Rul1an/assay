...
| **P1** | `K2` MCP authorization-discovery evidence | Planned next bounded evidence wave after `K1-A` stabilization: first-class visibility for MCP authorization-discovery surfaces before any auth-discovery pack. `K2-A` Phase 1 is now frozen as a pre-implementation contract. | Evidence-first, CI-native, no pack or engine bump in the same wave; see [PLAN-K2](architecture/PLAN-K2-MCP-AUTHORIZATION-DISCOVERY-EVIDENCE-2026q2.md), [K2-A freeze](architecture/K2-A-PHASE1-FREEZE.md), and [K2-A freeze prep](architecture/K2-A-PHASE1-FREEZE-PREP.md). |
...
- [ ] **`K2-A` Phase 1 — MCP authorization-discovery evidence** — planned next bounded evidence wave after `K1-A` stabilization; contract now frozen, implementation still pending; one honest discovery seam before any auth-discovery pack — [PLAN-K2](architecture/PLAN-K2-MCP-AUTHORIZATION-DISCOVERY-EVIDENCE-2026q2.md), [K2-A freeze](architecture/K2-A-PHASE1-FREEZE.md), [K2-A freeze prep](architecture/K2-A-PHASE1-FREEZE-PREP.md)
