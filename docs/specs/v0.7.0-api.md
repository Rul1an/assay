# Assay SDK v0.7.0 API Specification

**Goal**: SDK-native Evaluation (`from assay_sdk import Evaluator`).

## 1. Evaluator API (`assay_sdk/evaluator.py`)
...
## 2. Result API (`assay_sdk/result.py`)
...
## 3. Config Model (`assay_sdk/config.py`)
