...
curl -fLO https://github.com/Rul1an/assay/releases/download/v5.5.2/assay-v5.5.2-x86_64-unknown-linux-gnu.tar.gz
curl -fLO https://github.com/Rul1an/assay/releases/download/v5.5.2/assay-v5.5.2-x86_64-unknown-linux-gnu.tar.gz.sha256
sha256sum -c assay-v5.5.2-x86_64-unknown-linux-gnu.tar.gz.sha256
```
...
tar -xzf assay-v5.5.2-x86_64-unknown-linux-gnu.tar.gz
sudo install -m 0755 assay-v5.5.2-x86_64-unknown-linux-gnu/assay /usr/local/bin/assay
assay --version
```
...
scp assay-v5.5.2-x86_64-unknown-linux-gnu.tar.gz air-gapped-server:/tmp/
ssh air-gapped-server 'cd /tmp && tar -xzf assay-v5.5.2-x86_64-unknown-linux-gnu.tar.gz && sudo install -m 0755 assay-v5.5.2-x86_64-unknown-linux-gnu/assay /usr/local/bin/assay'
```
