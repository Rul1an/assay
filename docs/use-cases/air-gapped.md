...
curl -fLO https://github.com/Rul1an/assay/releases/download/v6.1.1/assay-v6.1.1-x86_64-unknown-linux-gnu.tar.gz
curl -fLO https://github.com/Rul1an/assay/releases/download/v6.1.1/assay-v6.1.1-x86_64-unknown-linux-gnu.tar.gz.sha256
sha256sum -c assay-v6.1.1-x86_64-unknown-linux-gnu.tar.gz.sha256
```
...
tar -xzf assay-v6.1.1-x86_64-unknown-linux-gnu.tar.gz
sudo install -m 0755 assay-v6.1.1-x86_64-unknown-linux-gnu/assay /usr/local/bin/assay
assay --version
```
...
scp assay-v6.1.1-x86_64-unknown-linux-gnu.tar.gz air-gapped-server:/tmp/
ssh air-gapped-server 'cd /tmp && tar -xzf assay-v6.1.1-x86_64-unknown-linux-gnu.tar.gz && sudo install -m 0755 assay-v6.1.1-x86_64-unknown-linux-gnu/assay /usr/local/bin/assay'
```
