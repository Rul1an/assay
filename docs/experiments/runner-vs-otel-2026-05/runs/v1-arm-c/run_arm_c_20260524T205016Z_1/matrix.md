...
|---|---|---|---|---|---|
| run identity (run_id) | run_arm_c_20260524T205016Z_1 | run_arm_c_20260524T205016Z_1 | assay.run.id | correlation |  |
| archive schema | assay.runner.archive_manifest.v0 | assay.runner.archive_manifest.v0 | assay.archive.schema | provenance |  |
| manifest digest binding | sha256:fe9138194036a7a899347c801b4d1f95b42907205928124da385b0ef63dcd600 | sha256:fe9138194036a7a899347c801b4d1f95b42907205928124da385b0ef63dcd600 | tamper-evident-match | tamper-evident binding |  |
...
| filesystem paths | n/a (not in trace contract) | present | none | measured effect; bounded negative if health is clean | /opt/actions-runner/_work/assay/assay/arm-c-runs/run_arm_c_20260524T205016Z_1/trace.json, /opt/actions-runner/_work/assay/assay/arm-c-runs/run_arm_c_20260524T205016Z_1/workdir/openai-agents-input.txt, /opt/actions-runner/_work/assay/assay/docs/experiments/runner-vs-otel-2026-05/workload/dist/manifest-binding.js |
