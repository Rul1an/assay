...
| Semantic-gap finding | `experiment-scoped` | `assay.experiment.agent_observability_fidelity.semantic_gap_verdict.v0` under [`semantic-gap-scenario-plan.md`](../experiments/agent-observability-fidelity-2026-05/semantic-gap-scenario-plan.md), delegated baseline planning in [`delegated-baseline-plan.md`](../experiments/agent-observability-fidelity-2026-05/delegated-baseline-plan.md), and the Slice 7 smoke record in [`runs/slice7-delegated-baseline/summary.md`](../experiments/agent-observability-fidelity-2026-05/runs/slice7-delegated-baseline/summary.md) | Synthetic matrix verdicts for reported-intent vs measured-effect divergence, plus a delegated positive-baseline smoke gate. Not a delegated gap finding or product API. |
