...
| `assay.experiment.agent_observability_fidelity.interop_coverage_cell.v0` | OTel GenAI / OpenInference / Runner coverage and claim-strength matrix row | experiment-scoped; harness-ready; synthetic only; not a product API | [`interop-coverage-cell-v0.schema.json`](../../experiments/agent-observability-fidelity-2026-05/schema/interop-coverage-cell-v0.schema.json) |
