...
| `tests/fixtures/runner-spike/` | deterministic acceptance fixtures (S5 OpenAI Agents + shared cross-runtime helpers; the Gemini fixture moved to `runner-fixtures/` in Slice 5A) | candidate runner fixtures under shared fixture contract; Slice 5B will move the S5 OpenAI Agents fixture to `runner-fixtures/openai-agents/` |
