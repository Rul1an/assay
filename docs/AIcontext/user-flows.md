...
**Steps:**
1. **Install**: `cargo install assay-cli --version 6.6.2 --locked` or use a verified release asset; install the Python SDK separately with `pip install assay-it`. CPython 3.12, 3.13, and 3.14 on macOS x86_64/arm64 and Linux x86_64; other interpreters and platforms are not claimed.
