...
| assay.receipt.mastra.score_event.v1 | experimental | Mastra ScoreEvent-derived score receipt | [PLAN-P14c §6](../architecture/PLAN-P14C-MASTRA-SCOREEVENT-RECEIPT-IMPORT-2026q2.md#6-v1-receipt-payload) | mastra_score_event::tests::import_writes_verifiable_score_event_bundle |
