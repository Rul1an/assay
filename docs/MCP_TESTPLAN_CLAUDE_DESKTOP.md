...
```json
{
  "mcpServers": {
    "filesystem-safe": {
      "command": "/Users/roelschuurkes/assay/target/release/assay",
      "args": [
        "mcp",
        "wrap",
        "--policy",
        "/Users/roelschuurkes/assay-mcp-tests/policies/claude_production.yaml",
        "--verbose",
        "--audit-log",
        "/Users/roelschuurkes/assay-mcp-tests/logs/claude_audit.jsonl",
        "--",
        "npx",
        "-y",
        "@anthropic-ai/mcp-server-filesystem",
        "/Users/roelschuurkes/safe-directory"
      ]
    }
  }
}
