...
| | Companions: [ADR-025 Index](./ADR-025-INDEX.md), [ADR-025 I1 Closure Note](./ADR-025-I1-CLOSURE-NOTE.md), [ADR-025 I2 Closure Release Integration (Step4 Closed-Loop)](./ADR-025-I2-CLOSURE-RELEASE-INTEGRATION.md), [ADR-025 I2 Stabilization Policy (v1)](./ADR-025-I2-STABILIZATION-POLICY.md), [ADR-025 I3 — OTel Bridge Release Integration (v1)](./ADR-025-I3-OTEL-RELEASE-INTEGRATION.md), [ADR-025 I3 Stabilization Policy (v1)](./ADR-025-I3-STABILIZATION-POLICY.md), [ADR-025 Soak Enforcement Policy (v1)](./ADR-025-SOAK-ENFORCEMENT-POLICY.md) | | |
