...
| **`v3.3.0` release line** | release commit `1aa597c3` + tag [`v3.3.0`](https://github.com/Rul1an/assay/releases/tag/v3.3.0) | `CHANGELOG.md`<br>`docs/architecture/RELEASE-PLAN-TRUST-COMPILER-3.3.md` | First public release line bundling the trust-compiler baseline: Trust Basis, Trust Card schema 2 / 7 claims, G3, engine 1.2, built-in `mcp-signal-followup`, built-in `a2a-signal-followup`, migration SSOT | **Yes** | **GitHub release + crates.io `3.3.0`** |
