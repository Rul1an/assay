...
The current plan and closure slices only froze:
- adapter API/workspace shape
- deterministic conversion behavior
- fixtures/tests/reviewer gates

They did **not** freeze crates.io distribution as part of ADR-026.
...
- external versioning/support expectations for ACP/A2A adapter crates
