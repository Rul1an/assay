...
- [PLAN — P9b Pydantic ReportCase Result Evidence Recut (Q2 2026)](./PLAN-P9B-PYDANTIC-REPORTCASE-RESULT-EVIDENCE-2026q2.md) — next selected Pydantic slice: recut the old report-wrapper sample around one `ReportCase`-derived result, importer-only if it graduates, not a Trust Basis claim or public receipt family
