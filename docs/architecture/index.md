...
| [RFC-005: Trust Compiler MVP](./RFC-005-trust-compiler-mvp-2026q2.md) | Active (`T1a`..`P2c` on `main`; `K1` formalized as the next evidence wave) | Bounded plan for the trust-compiler and Trust Card line |
