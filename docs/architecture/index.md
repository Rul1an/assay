...
- [PLAN — P14b Mastra ScoreEvent / ExportedScore Evidence Interop (Q2 2026)](./PLAN-P14B-MASTRA-SCORE-RECORD-EVIDENCE-2026q2.md) — maintainer-guided Mastra recut around `ObservabilityExporter` + `ScoreEvent` + `ExportedScore`, explicitly pre-proof on the live callback path
