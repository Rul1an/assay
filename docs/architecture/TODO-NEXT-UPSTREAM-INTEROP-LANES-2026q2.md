...
> [P9b Pydantic ReportCase Result Evidence Recut](./PLAN-P9B-PYDANTIC-REPORTCASE-RESULT-EVIDENCE-2026q2.md):
> a small per-case recut of the existing Pydantic sample. This keeps the current
> strategy artifact-first and importer-only before considering any new public
> receipt family.
