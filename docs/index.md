...
For model inventory/provenance boundaries, use the third adoption path:
[CycloneDX ML-BOM Model to Inventory Receipt](use-cases/cyclonedx-mlbom-model-to-inventory-receipt.md).
...
Current release: [`v5.4.0`](https://github.com/Rul1an/assay/releases/tag/v5.4.0). Continue with the [release-pinned agent golden path](guides/agent-golden-path.md), which records the driven CLI/MCP outcomes and their explicit non-claims.
...
-   :material-clipboard-check:{ .lg .middle } __Trust Basis & Receipts__
    ...
    [:octicons-arrow-right-24: CycloneDX Inventory Receipts](use-cases/cyclonedx-mlbom-model-to-inventory-receipt.md)
