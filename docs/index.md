...
Current release: [`v5.3.0`](https://github.com/Rul1an/assay/releases/tag/v5.3.0). Continue with the [release-pinned agent golden path](guides/agent-golden-path.md), which records the driven CLI/MCP outcomes and their explicit non-claims.
