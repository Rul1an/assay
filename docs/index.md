...
Current release: [`v6.4.0`](https://github.com/Rul1an/assay/releases/tag/v6.4.0). Continue with the [release-pinned agent golden path](guides/agent-golden-path.md), which records the driven CLI/MCP outcomes and their explicit non-claims.
