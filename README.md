...
Current release: [`v5.4.0`](https://github.com/Rul1an/assay/releases/tag/v5.4.0). [CHANGELOG.md](CHANGELOG.md) and release notes remain the authority for released behavior; merged changes after the tag are `Unreleased`, and crates.io publication is separate from merge state.
