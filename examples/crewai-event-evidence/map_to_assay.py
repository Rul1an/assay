"""Map exported CrewAI NDJSON into Assay-shaped placeholder envelopes."""
...
PLACEHOLDER_EVENT_TYPE = "example.placeholder.crewai-runtime-event"
PLACEHOLDER_SOURCE = "urn:example:assay:external:crewai"
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Map CrewAI NDJSON into Assay-shaped placeholder envelopes."
    )
    parser.add_argument("input", type=Path, help="CrewAI NDJSON export to read.")
    parser.add_argument(
        "--output",
        type=Path,
        required=True,
    ...
    parser.add_argument(
        "--assay-run-id",
        default=None,
        help="Optional Assay run id override. Defaults to import-crewai-<stem>.",
    )
    parser.add_argument(
        "--overwrite",
        action="store_true",
...
def main() -> int:
    ...
    assay_run_id = args.assay_run_id or f"import-crewai-{args.input.stem}"
