...
The generated measurement line above comes directly from [`adequacy/results.json`](../adequacy/results.json) through
[`adequacy/project_published_numbers.py`](../adequacy/project_published_numbers.py). The third-party interpretation remains editorial and is not presented as a producer measurement.
