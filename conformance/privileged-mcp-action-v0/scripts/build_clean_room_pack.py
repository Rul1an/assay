...
profile's rules, and even those only at the points the cases probe. **Twenty-three
...
will we. And if you implemented any of the twenty-three anyway, say which: no case
