...
| `rfc8785-canonicalization` | batch (test-names) | **2 of 2 in scope (100.0%), 0 survivors.** The denominator is exactly two author-declared rules in the pinned `serde_jcs` dependency: UTF-16 object-key ordering and ECMAScript-compatible number serialization. The wrapper swap remains a separate control. This is not RFC certification, corpus coverage, or full implementation adequacy |
