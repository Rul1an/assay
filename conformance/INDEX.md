...
| `rfc8785-canonicalization` | batch (test-names) | **3 of 3 in scope (100.0%), 0 survivors.** The denominator is exactly three author-declared rules in the pinned `serde_jcs` dependency: UTF-16 object-key ordering, ECMAScript-compatible number serialization, and section 3.2.2.2 Unicode string emission. The wrapper swap remains a separate control. This is not RFC certification, corpus coverage, or full implementation adequacy |
