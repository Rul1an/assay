...
mutate_and_expect_failure ghcr-installation-other-image docs/getting-started/installation.md \
...
if [ "$mutation_count" -ne 130 ]; then
  echo "FAIL: expected 130 release-surface mutations, observed $mutation_count" >&2
  exit 1
fi
