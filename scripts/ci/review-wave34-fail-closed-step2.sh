...
ALLOWLIST=(
  ...
  "docs/contributing/SPLIT-CHECKLIST-wave34-fail-closed-step2.md"
  "docs/contributing/SPLIT-MOVE-MAP-wave34-fail-closed-step2.md"
  "docs/contributing/SPLIT-REVIEW-PACK-wave34-fail-closed-step2.md"
...
while IFS= read -r f; do
  ...
  if [[ "$f" == .github/workflows/* ]]; then
    echo "FAIL: Wave34 Step2 must not touch workflows ($f)"
    exit 1
  fi
