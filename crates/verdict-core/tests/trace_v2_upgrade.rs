...
use verdict_core::trace::upgrader::StreamUpgrader;

#[test]
fn test_upgrade_v1_to_v2_stream() {
    // 1. Prepare V1 JSONL input
    let v1_json = r#"{"schema_version":1,"type":"verdict.trace","request_id":"req-123","prompt":"Hello","response":"World","meta":{"foo":"bar"}}
{"schema_version":1,"type":"verdict.trace","request_id":"req-456","prompt":"Hi","response":"There","meta":{}}"#;
...
fn test_mixed_stream_passthrough() {
    let input = r#"{"schema_version":1,"type":"verdict.trace","request_id":"v1-req","prompt":"p","response":"r"}
