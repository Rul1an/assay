...
#[map]
static CIDR_RULES_V4: LpmTrie<[u8; 4], u8> = LpmTrie::with_max_entries(MAX_CIDR_RULES, 0);

#[map]
static CIDR_RULES_V6: LpmTrie<[u8; 16], u8> = LpmTrie::with_max_entries(MAX_CIDR_RULES, 0);
