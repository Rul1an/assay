...
/// Canonical marketplace slug: `Rul1an/assay-action@v3`.
...
jobs:
  assay:
    ...
    steps:
      ...
      - name: Setup Assay
        uses: Rul1an/assay-action@v3 # For strict supply-chain pinning, use a full commit SHA. Exact tags (e.g. v3.1.0) are less strict.
